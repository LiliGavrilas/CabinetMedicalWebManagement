...
{
	$image = ($row->gender == "Male") ? "/Chat/Img/user_male.jpg" : "/Chat/Img/user_female.jpg";
	...
	<img id='trash' src='/Chat/Img/trash.png' onclick='delete_message(event)' msgid='$data->id' />
	</div> ";
...
function message_right($data,$row)
{
	...
	if($data->seen){
		$a .="<img src='/Chat/Img/tick.png' style=''/>";
	}elseif($data->received){
		$a .="<img src='/Chat/Img/tick_grey.png' style=''/>";
	}
...
function message_controls()
{
	...
	<div style='display:flex;width:100%;height:40px;'>
		<label for='message_file'><img src='/Chat/Img/clip.png' style='opacity:0.8;width:30px;margin:5px;cursor:pointer;' ></label>
